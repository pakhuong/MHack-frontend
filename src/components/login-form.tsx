...
export function LoginForm({
  ...
  return (
    <div className={cn('flex flex-col gap-6', className)} {...props}>
          ...
          <form>
            <div className="grid gap-6">
              ...
              <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-zinc-700">
                <span className="relative z-10 bg-zinc-900 px-2 text-gray-400">
                  Or continue with
                </span>
              </div>
              <div className="grid gap-6">
      ...
      <div className="text-balance text-center text-xs text-gray-400 [&_a]:underline [&_a]:underline-offset-4 [&_a]:hover:text-white">
